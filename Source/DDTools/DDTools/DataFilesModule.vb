...
Module DataFilesModule
    ...
    Public Sub GetTilesAndWalls(Source As String)
        ...
        DDToolsForm.DataFilesDataGridView.Columns("Color").DefaultCellStyle.Font = New Font("Courier New", 10, FontStyle.Regular)
        ...
        DDToolsForm.DataFilesDataGridView.AllowUserToResizeColumns = False
